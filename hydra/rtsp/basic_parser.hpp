...
#include <boost/hydra/rtsp/detail/basic_parser.hpp>
...
/** A parser for decoding HTTP/1 wire format messages.
    ...
    @ref hydra::basic_flat_buffer class is provided, which guarantees
    ...
    of the parser, use @ref hydra::basic_flat_buffer with HTTP algorithms
...
public:
    ...
    */
    ...
    /** Write a buffer sequence to the parser.
        ...
        The class @ref hydra::basic_flat_buffer is provided as one way to
...
#include <boost/hydra/rtsp/impl/basic_parser.hpp>
