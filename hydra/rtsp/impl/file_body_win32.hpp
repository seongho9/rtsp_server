...
#include <boost/hydra/rtsp/write.hpp>
...
struct basic_file_body<file_win32>
{
    ...
    public:
        ...
        get(error_code& ec)
        {
            std::size_t const n = (std::min)(sizeof(buf_),
                hydra::detail::clamp(body_.last_ - pos_));
            if(n == 0)
            {
                ec = {};
                return boost::none;
    ...
    public:
            ...
            error_code& ec)
        {
            ...
            for(auto buffer : hydra::buffers_range_ref(buffers))
            {
...
// https://github.com/boostorg/hydra/issues/1815
...
template<
    ...
    class Handler>
class write_some_win32_op
    : public hydra::async_base<Handler, Executor>
{
