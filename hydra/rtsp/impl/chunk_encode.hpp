...
#include <boost/hydra/core/detail/varint.hpp>
#include <boost/hydra/rtsp/error.hpp>
#include <boost/hydra/rtsp/detail/rfc7230.hpp>
#include <algorithm>
...
increment()
{
    using hydra::detail::varint_read;
...
*/
    using hydra::detail::varint_size;
    using hydra::detail::varint_write;
    using CharT = char;
