...
#include <boost/hydra/rtsp/message_generator.hpp>
#include <boost/smart_ptr/make_unique.hpp>
#include <boost/hydra/core/buffers_generator.hpp>
...
message_generator::message_generator(
    rtsp::message<isRequest, Body, Fields>&& m)
    ...
    : message_generator::impl_base
{
    ...
    {
        sr_.consume((std::min)(n, hydra::buffer_bytes(current_)));
    }
...
private:
    ...
    rtsp::message<isRequest, Body, Fields> m_;
    rtsp::serializer<isRequest, Body, Fields> sr_;
