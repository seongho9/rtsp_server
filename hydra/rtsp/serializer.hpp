...
#include <boost/hydra/core/buffers_suffix.hpp>
#include <boost/hydra/core/string.hpp>
#include <boost/hydra/core/detail/variant.hpp>
...
private:
    enum
    {
        ...
        //  serializer 객체의 초기화
        do_init             =  10,
        //  serializer 객체의 헤더만 직렬화, 바디는 x
        do_header_only      =  20,
        //  serializer 객체의 헤더 직렬화, 바디는 이후에 가능
        do_header           =  30,
        //  serializer 객체의 바디 직렬화
        do_body             =  40,
...
#include <boost/hydra/rtsp/impl/serializer.hpp>
