...
#include <boost/hydra/core/buffers_prefix.hpp>
#include <boost/hydra/core/static_buffer.hpp>
...
class write_op
    : public async_base<Handler,
        hydra::executor_type<flat_stream>>
{
public:
    template<
...
struct run_write_op
{
        ...
        Buffers const& b)
    {
        ...
        static_assert(
            hydra::detail::is_invocable<WriteHandler,
...
{
    static_assert(boost::hydra::is_sync_read_stream<next_layer_type>::value,
...
async_read_some(
    ...
    ReadHandler&& handler)
{
    static_assert(boost::hydra::is_async_read_stream<next_layer_type>::value,
...
{
    static_assert(boost::hydra::is_sync_write_stream<next_layer_type>::value,
...
write_some(ConstBufferSequence const& buffers, error_code& ec)
{
    ...
    return stream_.write_some(
        boost::hydra::buffers_prefix(result.size, buffers), ec);
}
...
{
    static_assert(boost::hydra::is_async_write_stream<next_layer_type>::value,
...
// void
// teardown(
//     boost::hydra::role_type role,
//     flat_stream<NextLayer>& s,
//     error_code& ec)
// {
//     using boost::hydra::websocket::teardown;
...
// {
//     using boost::hydra::websocket::async_teardown;
