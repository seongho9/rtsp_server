...
#include <boost/hydra/core/detail/static_const.hpp>
#include <boost/hydra/core/detail/stream_traits.hpp>
...
/** Return the lowest layer in a stack of stream layers.
    ...
    `net::ssl::stream` or @ref hydra::websocket::stream. The owner of a stream
...
struct close_socket_impl
{
    ...
    operator()(T& t) const
    {
        using hydra::beast_close_socket;
