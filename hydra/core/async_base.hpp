...
#include <boost/hydra/core/bind_handler.hpp>
#include <boost/hydra/core/detail/allocator.hpp>
#include <boost/hydra/core/detail/async_base.hpp>
#include <boost/hydra/core/detail/filtering_cancellation_slot.hpp>
#include <boost/hydra/core/detail/work_guard.hpp>
...
public:
    ...
    If a class derived from @ref boost::hydra::async_base is a completion
...
public:
  ...
  */
    using cancellation_slot_type =
            hydra::detail::filtering_cancellation_slot<net::associated_cancellation_slot_t<Handler>>;
    ...
    */
    ...
    /** Invoke the final completion handler, maybe using post.
        ...
        @ref boost::hydra::async_base::complete or
        @ref boost::hydra::async_base::complete_now more than once.

        Any temporary objects allocated with @ref boost::hydra::allocate_stable will
        ...
        @ref boost::hydra::async_base::complete_now.
    ...
    */
    ...
    /** Invoke the final completion handler.
        ...
        This invokes the final completion handler with the specified
        arguments forwarded. It is undefined to call either of
        @ref boost::hydra::async_base::complete or @ref boost::hydra::async_base::complete_now more than once.
...
/** Base class to provide completion handler boilerplate for composed operations.
    ...
    @li The free function @ref hydra::allocate_stable may be used to allocate
    one or more temporary objects associated with the composed operation.
    ...
    allocates temporary memory using @ref hydra::allocate_stable for the timer and
...
#include <boost/hydra/core/impl/async_base.hpp>
