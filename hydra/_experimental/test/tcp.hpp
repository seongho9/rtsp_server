...
#include <boost/hydra/core/detail/get_io_context.hpp>
#include <boost/hydra/_experimental/unit_test/suite.hpp>
#include <boost/hydra/_experimental/test/handler.hpp>
...
{
    auto ioc1 = hydra::detail::get_io_context(s1);
    auto ioc2 = hydra::detail::get_io_context(s2);
    ...
    {
        hydra::unit_test::suite::this_suite()->fail(
