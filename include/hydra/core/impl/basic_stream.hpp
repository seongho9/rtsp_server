    ...
    , public boost::asio::coroutine
{
        ...
        std::size_t amount, std::true_type)
    {
        impl_->socket.async_read_some(
            hydra::buffers_prefix(amount, b_),
                std::move(*this));
    }
...
public:
        ...
        , b_(b)
    {
        ...
        {
            // Workaround:
            // Corner case discovered in https://github.com/boostorg/hydra/issues/2065
        ...
        std::size_t bytes_transferred = 0)
    {
        BOOST_ASIO_CORO_REENTER(*this)
        {
            ...
            if(detail::buffers_empty(b_))
            {
                ...
                {
                    impl_->close();
                    BOOST_BEAST_ASSIGN_EC(ec, hydra::error::timeout);
                }
                goto upcall;
            }
...
//     error_code& ec)
// {
//     using hydra::websocket::teardown;
...
// {
//     using hydra::websocket::async_teardown;
