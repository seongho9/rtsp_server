...
#include <boost/hydra/core/detail/tuple.hpp>
...
struct associated_executor<
    hydra::detail::bind_wrapper<Handler, Args...>, Executor>
{
    using type = typename
    ...
    static
    type
    get(hydra::detail::bind_wrapper<Handler, Args...> const& op,
...
template<class Handler, class... Args, class Executor>
struct associated_executor<
    hydra::detail::bind_front_wrapper<Handler, Args...>, Executor>
{
    using type = typename
        associated_executor<Handler, Executor>::type;
    ...
    static
    type
    get(hydra::detail::bind_front_wrapper<Handler, Args...> const& op,
        Executor const& ex = Executor{}) noexcept
    {
        return associated_executor<
            Handler, Executor>::get(op.h_, ex);
...
struct associated_allocator<
    hydra::detail::bind_wrapper<Handler, Args...>, Allocator>
{
    using type = typename
...
template<class Handler, class... Args, class Allocator>
struct associated_allocator<
    hydra::detail::bind_front_wrapper<Handler, Args...>, Allocator>
{
    using type = typename
        associated_allocator<Handler, Allocator>::type;
...
struct associated_cancellation_slot<
    hydra::detail::bind_wrapper<Handler, Args...>, CancellationSlot>
{
    using type = typename
...
template<class Handler, class... Args, class CancellationSlot>
struct associated_cancellation_slot<
    hydra::detail::bind_front_wrapper<Handler, Args...>, CancellationSlot>
{
    using type = typename
        associated_cancellation_slot<Handler>::type;
...
template<class Handler, class... Args>
void
bind(boost::hydra::detail::bind_wrapper<
    Handler, Args...>, ...) = delete;

template<class Handler, class... Args>
void
bind(boost::hydra::detail::bind_front_wrapper<
    Handler, Args...>, ...) = delete;
