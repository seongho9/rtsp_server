...
#include <boost/hydra/core/detail/flat_stream.hpp>
...
/** Stream wrapper to improve write performance.
    ...
    @see
        ...
        @li https://github.com/boostorg/hydra/issues/1108
...
public:
    ...
    using executor_type = hydra::executor_type<next_layer_type>;
...
#include <boost/hydra/core/impl/flat_stream.hpp>
