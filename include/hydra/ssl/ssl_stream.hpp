...
// This include is necessary to work with `ssl::stream` and `boost::hydra::websocket::stream`

#include <boost/hydra/core/flat_stream.hpp>
...
/** Provides stream-oriented functionality using OpenSSL
    ...
    @code
        ...
        hydra::ssl_stream<hydra::tcp_stream> sock{ioc, ctx};
    @endcode
    ...
    : public net::ssl::stream_base
{
    ...
    using stream_type = boost::hydra::flat_stream<ssl_stream_type>;
...
public:
    ...
    */
    ...
    /** Get the underlying implementation in the native type.
        ...
        @code
        boost::hydra::ssl_stream<net::ip::tcp::socket> ss{ioc, ctx};
    ...
    */
    ...
    // These hooks are used to inform boost::hydra::websocket::stream on
