...
#include <boost/hydra/core/buffers_range.hpp>
#include <boost/hydra/core/make_printable.hpp>
    ...
    , public asio::coroutine
{
    ...
    net::cancellation_state st_{this->
        hydra::async_base<Handler, hydra::executor_type<Stream>>
...
public:
        ...
        ConstBufferSequence const& buffers) const
    {
        ...
        if(os_.fail())
            return;
        std::size_t bytes_transferred = 0;
        for(auto b : hydra::buffers_range_ref(buffers))
        {
    ...
    header<true, Fields> const& h)
{
    ...
    return os << hydra::make_printable(fr.get());
}
