...
#include <boost/hydra/rtsp/detail/type_traits.hpp>
...
template<class T>
struct is_body_writer<T, hydra::detail::void_t<
    typename T::writer,
...
template<class T>
struct is_mutable_body_writer<T, hydra::detail::void_t<
    typename T::writer,
    typename T::writer::const_buffers_type,
        decltype(
    std::declval<typename T::writer&>().init(std::declval<error_code&>()),
...
template<class T>
struct is_body_reader<T, hydra::detail::void_t<decltype(
