...
public:
    ...
    public:
        ...
        /// Returns the field enum, which can be @ref boost::hydra::rtsp::field::unknown
        field
        name() const;
...
#else
    struct key_compare : hydra::iless
#endif
    {
...
private:
    ...
    using rebind_type = typename
        hydra::detail::allocator_traits<Allocator>::
            template rebind_alloc<align_type>;

    using alloc_traits =
        hydra::detail::allocator_traits<rebind_type>;

    using size_type = typename
        hydra::detail::allocator_traits<Allocator>::size_type;
...
public:
    ...
    */
    ...
    /** Insert a field.
        ...
        @param value The value of the field, as a @ref boost::hydra::string_view
    */
    void
    ...
    */
    ...
    /// @copydoc boost::hydra::rtsp::basic_fields::equal_range(boost::hydra::rtsp::field) const
    std::pair<const_iterator, const_iterator>
...
#include <boost/hydra/rtsp/impl/fields.hpp>
