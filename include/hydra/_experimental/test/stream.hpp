...
#include <boost/hydra/core/flat_buffer.hpp>
#include <boost/hydra/core/role.hpp>
#include <boost/hydra/core/string.hpp>
#include <boost/hydra/_experimental/test/fail_count.hpp>
#include <boost/hydra/_experimental/test/detail/stream_state.hpp>
...
/** A two-way socket useful for unit testing
    ...
    @ref boost::hydra::rtsp::async_write for example.
    ...
    @li The input area, represented by a @ref hydra::basic_flat_buffer,
...
#include <boost/hydra/_experimental/test/impl/stream.hpp>
