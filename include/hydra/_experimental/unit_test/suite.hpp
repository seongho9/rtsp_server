...
#include <boost/hydra/_experimental/unit_test/runner.hpp>
...
#ifndef BEAST_PASS
#define BEAST_PASS() ::boost::hydra::unit_test::suite::this_suite()->pass()
#endif

#ifndef BEAST_FAIL
#define BEAST_FAIL() ::boost::hydra::unit_test::suite::this_suite()->fail("", __FILE__, __LINE__)
#endif
...
*/
#define BEAST_EXPECT(cond) ::boost::hydra::unit_test::suite::this_suite()->expect(cond, __FILE__, __LINE__)
#endif
...
#define BEAST_EXPECTS(cond, reason) ((cond) ? \
    (::boost::hydra::unit_test::suite::this_suite()->pass(), true) : \
    (::boost::hydra::unit_test::suite::this_suite()->fail((reason), __FILE__, __LINE__), false))
#endif
...
#define BEAST_DEFINE_TESTSUITE_INSERT(Library,Module,Class,manual) \
    static ::boost::hydra::unit_test::detail::insert_suite <Class##_test>   \
...
/** Define a unit test suite.
    ...
    struct aged_ordered_container_test : hydra::unit_test::suite
    {
        //...
    };
...
#else
#include <boost/hydra/_experimental/unit_test/global_suites.hpp>
